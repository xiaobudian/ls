...
namespace System
{
    ...
    public static class ParamterCheckExtensions
    {
        ...
        {
            Require<ArgumentNullException>(value != null, string.Format(ls.common.Resources.ParameterCheck_NotNull, paramName));
        }
        ...
        public static void CheckNotNullOrEmpty(this string value, string paramName)
        {
            ...
            Require<ArgumentException>(value.Length > 0, string.Format(ls.common.Resources.ParameterCheck_NotNullOrEmpty_String, paramName));
        }
        ...
        {
            Require<ArgumentException>(value != Guid.Empty, string.Format(ls.common.Resources.ParameterCheck_NotEmpty_Guid, paramName));
        }
        ...
        public static void CheckNotNullOrEmpty<T>(this IEnumerable<T> collection, string paramName)
        {
            ...
            Require<ArgumentException>(collection.Any(), string.Format(ls.common.Resources.ParameterCheck_NotNullOrEmpty_Collection, paramName));
        }
        ...
        public static void CheckLessThan<T>(this T value, string paramName, T target, bool canEqual = false) where T : IComparable<T>
        {
            ...
            string format = canEqual ? ls.common.Resources.ParameterCheck_NotLessThanOrEqual : ls.common.Resources.ParameterCheck_NotLessThan;
        ...
        {
            bool flag = canEqual ? value.CompareTo(target) >= 0 : value.CompareTo(target) > 0;
            string format = canEqual ? ls.common.Resources.ParameterCheck_NotGreaterThanOrEqual : ls.common.Resources.ParameterCheck_NotGreaterThan;
            Require<ArgumentOutOfRangeException>(flag, string.Format(format, paramName, target));
        }
            ...
            where T : IComparable<T>
        {
            ...
            string message = startEqual
                ? string.Format(ls.common.Resources.ParameterCheck_BetweenNotEqual, paramName, start, end, start)
                : string.Format(ls.common.Resources.ParameterCheck_Between, paramName, start, end);
            Require<ArgumentOutOfRangeException>(flag, message);

            flag = endEqual ? value.CompareTo(end) <= 0 : value.CompareTo(end) < 0;
            message = endEqual
                ? string.Format(ls.common.Resources.ParameterCheck_BetweenNotEqual, paramName, start, end, end)
                : string.Format(ls.common.Resources.ParameterCheck_Between, paramName, start, end);
            Require<ArgumentOutOfRangeException>(flag, message);
        }
        ...
        public static void CheckDirectoryExists(this string directory, string paramName = null)
        {
            ...
            Require<DirectoryNotFoundException>(Directory.Exists(directory), string.Format(ls.common.Resources.ParameterCheck_DirectoryNotExists, directory));
        }
        ...
        public static void CheckFileExists(this string filename, string paramName = null)
        {
            ...
            Require<FileNotFoundException>(File.Exists(filename), string.Format(ls.common.Resources.ParameterCheck_FileNotExists, filename));
        }
    }
}